...
WITH dav_learnset AS (
    ...
    FROM read_parquet('s3://sandbox-datalake-silver/pokemon/showdown/dav/showdown_dav_learnset.parquet')
),
smogon_learnset AS (
    SELECT pokemon_id, move_id
    FROM read_parquet('s3://sandbox-datalake-silver/pokemon/showdown/smogon/showdown_smogon_learnset.parquet')
),
